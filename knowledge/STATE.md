...
Last updated: 2026-09-09 (PM GOLD: EXP-0015 margin 0.22, soft-weight GO). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (all five active) + RESULTS.md (EXP-0000…0015 rows).
...
- Next: EXP-0016 soft appearance-weighted assignment (H-003, TP-cost budget, window-gated); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0015 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0016 soft appearance weight, H-003):
bash scripts/new_experiment.sh EXP-0016 "<title>"
```
