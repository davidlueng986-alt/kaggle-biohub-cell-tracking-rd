...
Last updated: 2026-09-09 (PM GOLD: EXP-0014 STOPs scale direction, H-003 appearance next). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (all five active) + RESULTS.md (EXP-0000…0014 rows).
...
- Next: EXP-0015 H-003 appearance-similarity probe (patch correlation at link endpoints, CPU, window-gated); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0014 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0015 appearance probe, H-003):
bash scripts/new_experiment.sh EXP-0015 "<title>"
```
