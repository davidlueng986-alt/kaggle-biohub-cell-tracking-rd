...
- `knowledge/`: this file + HYPOTHESES.md (H-001/H-002/H-004/H-005 active; H-003 classical parked, learned-features residual) + RESULTS.md (EXP-0000…0046 + 0049/0050/0051 rows; 0047/0048 concurrent session).
...
- UNet v9 ESCAPED (watch 2026-09-11): loss 0.857→0.707 over ep0–1 (falling, off the 0.5018 attractor); recall 0 expected this early; HNM silent as designed (off); revised ETA ~1.5–2.5 h remaining. Early-warning stands: recall 0 past ~ep5 → review.
