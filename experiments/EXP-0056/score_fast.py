#!/usr/bin/env python3
"""EXP-0056 scorer driver (lives inside EXP dir; scripts/* untouched on disk).
...
N = max(n_pred, n_gt) per frame. At @95.0 (denser than @95.5's ~433
...
def equivalence_gate():
    """Prove scipy solver == pure-python solver on real @95.0 frames."""
...
def main():
    ...
    # ---- @95.0 diagnostics (recall/det/timing) + trusted score
    ...
    print(f"@95.0: det_total={det_total} det/f={det_total/100:.2f} "
    ...
    out = {
        "p950": {"recall": recall, "det_f": det_total / 100,
