...
Last updated: 2026-09-09 (PM GOLD: EXP-0010 combo dominates, @98.0 descent GO). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (all five active) + RESULTS.md (EXP-0000…0010 rows).
...
- Next: EXP-0011 full-video 6bba@98.0 (H-002; 44b6 level locked @99.0); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0010 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0011 full-video 6bba@98.0, H-002):
bash scripts/new_experiment.sh EXP-0011 "<title>"
```
