...
Last updated: 2026-09-09 (PM GOLD: EXP-0017 gate-10 first promotion candidate). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (H-001/H-002/H-004/H-005 active; H-003 classical parked, learned-features residual) + RESULTS.md (EXP-0000…0017 rows).
...
- EXP-0017 CANDIDATE: gate-10 oracle links, worst-fold 1.0884 (44b6 1.0998 / 6bba 1.0884), div-neutral, FP+1 — promotion PENDING EXP-0018 replication.
- EXP-0003: worst-fold edge 1.0705 (44b6 1.0933 / 6bba 1.0705), division 0/0/4.
...
- EXP-0007 DoG probe (image-based): pct99 recall 1.00 both; 6bba mini edge_raw 0.8462; ~1s/frame.
- EXP-0008 full-video (image-based): 44b6 recall 1.000 edge_raw 0.9038 (strong); 6bba recall 0.835 FALSIFIED → fix = @98.5 level; timing 2.05/0.84 s/frame (H-005 debt quantified, over budget unoptimized).
- Harness (toy): EXP-0001 0.600/0.333; EXP-0002 perfect 1.1, idswitch 0.333.
- Next: EXP-0018 jitter replication for gate-10 (H-002, EXP-0006 protocol); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0017 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0018 gate-10 replication, H-002):
bash scripts/new_experiment.sh EXP-0018 "<title>"
```
