...
- `knowledge/`: this file + HYPOTHESES.md (H-001/H-002/H-004/H-005 active; H-003 classical parked, learned-features residual) + RESULTS.md (EXP-0000…0025 rows).
...
# Loop (EXP-0001…0025 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# Next experiments (STAGE C dispatched, H-005):
bash scripts/new_experiment.sh EXP-0026 "<title>"
bash scripts/new_experiment.sh EXP-0027 "<title>"
```
