...
Last updated: 2026-09-09 (PM GOLD: EXP-0018 PROMOTES gate-10 — first promotion). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (H-001/H-002/H-004/H-005 active; H-003 classical parked, learned-features residual) + RESULTS.md (EXP-0000…0018 rows).
...
- Next: EXP-0019 gate-10 + r10-fork combination (must beat the NEW best both folds with div gain); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0018 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0019 gate-10+r10 combo, H-002/H-003):
bash scripts/new_experiment.sh EXP-0019 "<title>"
```
