...
- `knowledge/`: this file + HYPOTHESES.md (H-001/H-002/H-004/H-005 active; H-003 classical parked, learned-features residual) + RESULTS.md (EXP-0000…0042 rows).
...
# Loop (EXP-0001…0042 done — read them, don't recreate):
