...
Last updated: 2026-09-09 (PM GOLD: EXP-0019 combo passes bar, candidate pending replication). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (H-001/H-002/H-004/H-005 active; H-003 classical parked, learned-features residual) + RESULTS.md (EXP-0000…0019 rows).
...
- EXP-0019 CANDIDATE (pending EXP-0020 replication): gate-10+r10 combo, worst-fold 1.0895, div 3/0/1, fold0 identical (0 clean-tissue forks).
...
- Next: EXP-0020 combo replication (jitter + matched gate-10 base + LOO, pre-registered promote bar); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0019 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0020 combo replication, H-002/H-003):
bash scripts/new_experiment.sh EXP-0020 "<title>"
```
