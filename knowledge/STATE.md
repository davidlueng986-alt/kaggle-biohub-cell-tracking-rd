...
Last updated: 2026-09-09 (PM GOLD: EXP-0016 null treatment, H-003 classical parked). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (H-001/H-002/H-004/H-005 active; H-003 classical parked, learned-features residual) + RESULTS.md (EXP-0000…0016 rows).
...
- Next: EXP-0017 gap-closing probe for the 55 oracle FNs (H-002/H-005, t→t+2 links under sub-gate discipline); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0016 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0017 gap-closing, H-002/H-005):
bash scripts/new_experiment.sh EXP-0017 "<title>"
```
