...
Last updated: 2026-09-09 (PM GOLD: EXP-0011 overshoot stops descent, 6bba locks @98.5). Maintainer: gold-watch.
...
- `knowledge/`: this file + HYPOTHESES.md (all five active) + RESULTS.md (EXP-0000…0011 rows).
...
- Next: EXP-0012 watershed/splitter on oversize components (H-002, 6bba dense frames); first serious submit only after local gates + timing headroom.
...
# Loop (EXP-0001…0011 done — read them, don't recreate):
bash scripts/run_loop.sh --dry-run
python3 scripts/score.py --dry-run
python3 scripts/test_score.py
# New experiment (EXP-0012 watershed splitter, H-002):
bash scripts/new_experiment.sh EXP-0012 "<title>"
```
